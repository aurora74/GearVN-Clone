...
export const TECH_PRODUCT_QUERY_DICTIONARY: TechProductQueryDictionaryEntry[] = [
  {
    terms: ['laptop ai', 'học ai', 'hoc ai', 'machine learning', 'deep learning'],
    expansions: ['laptop', 'AI', 'CUDA', 'NVIDIA', 'RTX', 'RAM 16GB', 'sinh viên IT'],
  },
  {
    terms: ['laptop gaming', 'gaming laptop', 'chơi game', 'choi game'],
    expansions: ['laptop gaming', 'RTX', 'NVIDIA', 'tản nhiệt', 'màn hình 144Hz', 'game thủ'],
  },
  {
    terms: ['rtx', 'rtx 3050', 'rtx 4050', 'rtx 4060', 'rtx 4070', 'rtx 4080', 'rtx 4090'],
    expansions: ['GPU rời', 'NVIDIA GeForce', 'CUDA', 'đồ họa', 'gaming', 'render'],
  },
  {
  ...
  },
  {
    ...
    expansions: ['RAM 8GB', 'RAM 16GB', 'RAM 32GB', 'đa nhiệm', 'DDR4', 'DDR5'],
  },
  {
  ...
  },
  {
    ...
    expansions: ['màn hình', 'monitor', 'OLED', 'IPS', 'tần số quét', 'độ phủ màu'],
  },
  {
    terms: ['sinh viên', 'sinh vien', 'student'],
    expansions: ['sinh viên', 'học tập', 'laptop sinh viên', 'giá tốt', 'mỏng nhẹ'],
  },
  {
    terms: ['văn phòng', 'van phong', 'office'],
    expansions: ['văn phòng', 'office', 'pin tốt', 'mỏng nhẹ', 'bền bỉ', 'webcam'],
  },
  {
    terms: ['đồ họa', 'do hoa', 'render', 'creator', 'thiết kế', 'thiet ke'],
    expansions: ['đồ họa', 'render', 'creator', 'RTX', 'màn hình màu chuẩn', 'RAM 16GB'],
  },
  {
  ...
  },
  {
    ...
    expansions: ['pin tốt', 'battery', 'tiết kiệm điện', 'văn phòng', 'mỏng nhẹ'],
  },
  {
    terms: ['tai nghe', 'headphone', 'headset'],
    expansions: ['tai nghe', 'headset', 'gaming headset', 'micro', 'không dây'],
  },
  {
    terms: ['bàn phím', 'ban phim', 'keyboard'],
    expansions: ['bàn phím', 'keyboard', 'bàn phím cơ', 'wireless', 'bluetooth'],
  },
  {
  ...
  },
  {
    ...
    expansions: ['màn hình', 'monitor', 'IPS', 'OLED', '144Hz', 'eye comfort'],
  },
  {
    terms: ['asus', 'rog', 'tuf', 'acer', 'nitro', 'predator', 'msi', 'lenovo', 'legion', 'loq', 'hp', 'victus', 'omen', 'dell', 'alienware', 'gigabyte', 'aorus', 'apple', 'macbook'],
    expansions: ['laptop', 'thương hiệu laptop', 'gaming', 'văn phòng', 'creator'],
  },
];
