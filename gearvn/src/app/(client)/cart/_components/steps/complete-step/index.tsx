...
const getStatusConfig = (status: ReturnStatus): StatusConfig => {
  ...
  if (status === "pending") {
    return {
      icon: <Clock3 className="text-amber-500" size={64} />,
      title: "Thanh toán đang xử lý",
      titleClass: "text-amber-500",
      message: (
        <>
          Giao dịch của bạn đang được xác nhận. <br />
          Vui lòng kiểm tra lại trạng thái đơn hàng trong phần quản lý đơn hàng.
        </>
      ),
      showOrderDetails: true,
    };
